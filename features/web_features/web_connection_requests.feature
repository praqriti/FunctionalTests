...
Scenario: Verify User can send connection request to another user
	...
	When User searches for "student" and clicks search
	Then User should see "camfed_student_1" as an "unlinked" connection
	When User attempts to send connection request to "camfed_student_1"
	Then User should see the message "Connection request sent"
